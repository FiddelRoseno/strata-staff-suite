      ...
      <div className="relative z-10 container px-4 text-center text-white">
        <div className="max-w-4xl mx-auto">
          ...
          <Badge variant="secondary" className="mb-6 bg-white/20 text-white border-white/30">
            ...
            Confiado por 500+ Condomínios
          </Badge>

          {/* Main Heading */}
          <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">
            Conecte Sua Comunidade com
            <span className="block bg-gradient-to-r from-white to-primary-glow bg-clip-text text-transparent">
              Profissionais de Serviços Confiáveis
            </span>
          </h1>

          {/* Subheading */}
          <p className="text-xl md:text-2xl mb-8 text-white/90 max-w-2xl mx-auto">
            Encontre profissionais confiáveis para suas necessidades do condomínio ou ofereça seus serviços para comunidades locais
          </p>
      ...
      <div className="absolute bottom-8 left-8 hidden lg:block">
        <div className="bg-white/20 backdrop-blur-sm rounded-lg p-4 text-white">
          <div className="flex items-center space-x-2 mb-2">
            ...
            <span className="text-sm font-medium">Prestador Verificado</span>
          </div>
          <div className="text-xs text-white/80">Miguel T. - Serviços de Encanamento</div>
        </div>
      </div>
      ...
      <div className="absolute top-1/3 right-8 hidden lg:block">
        <div className="bg-white/20 backdrop-blur-sm rounded-lg p-4 text-white">
          <div className="flex items-center space-x-2 mb-2">
            ...
            <span className="text-sm font-medium">Avaliação 5.0</span>
          </div>
          <div className="text-xs text-white/80">Sarah L. - Serviços de Limpeza</div>
        </div>
      </div>
    </section>
  );
